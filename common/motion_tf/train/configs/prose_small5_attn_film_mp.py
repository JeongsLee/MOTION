...
class Cfg:
    ...
    router_mp = True             # grid message passing prepended to router (multi-dilation SAGE, regime-aware)
    router_mp_depth = 2
    router_mp_dilations = (1, 2, 4)
    ...
    jit_compile = True
    save_dir = "results/prose_small5_attn_film_mp"
    ckpt_every = 500
    seed = 0
