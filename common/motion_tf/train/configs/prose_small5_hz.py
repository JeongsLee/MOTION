...
class Cfg:
    ...
    batch = 1                    # per-replica; eff = 1 x 1 x accum(4) = 4. batch=2 OOM'd (6-expert N_p64 > 80GB)
    lr = 2e-4
    lr_decay = True
    warmup = 300
    instance_norm = False
    clipnorm = 1.0
    grad_accum = 4               # was 2; bumped to keep eff-batch=4 after batch 2->1 (OOM fix)
    bf16 = False
    grad_checkpoint = False
    jit_compile = True
    save_dir = "results/prose_small5_hz_norm"
    ckpt_every = 500
    seed = 0
