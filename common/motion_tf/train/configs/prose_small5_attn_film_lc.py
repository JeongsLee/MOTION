...
class Cfg:
    ...
    learned_combine = True       # Σ_k ω_{c,k}·B_k (per-channel per-expert weights, init=W_scale) — down-weight redundant experts
    ...
    jit_compile = True
    save_dir = "results/prose_small5_attn_film_lc"
    ckpt_every = 500
    seed = 0
